...
if ( ! class_exists( 'WP_Async_Request', false ) ) {
	include_once ANYSEARCH__PLUGIN_DIR . 'vendor/a5hleyrich/wp-background-processing/classes/wp-async-request.php';
}
if ( ! class_exists( 'WP_Background_Process', false ) ) {
	include_once ANYSEARCH__PLUGIN_DIR . 'vendor/a5hleyrich/wp-background-processing/classes/wp-background-process.php';
}
